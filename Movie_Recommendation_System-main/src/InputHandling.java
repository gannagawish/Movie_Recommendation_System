...
//
//        // Validate the format (should have exactly 2 parts: name and id)
//        if (parts.length != 2) {
//            System.out.println("Invalid format in line: '" + line + "'. Expected format: name,id");
//            return null;
//        }
//
...
//        if (name.isEmpty()) {
//            System.out.println("Invalid name in line: '" + line + "'. Name cannot be empty.");
//            return null;
//        }
//        if (id.isEmpty()) {
//            System.out.println("Invalid id in line: '" + line + "'. Id cannot be empty.");
//            return null;
//        }
//
